...
const OWNER_NAME = "Fukaina";
const NOMOR_BOT = "6285189028801"; // 628xx nomor wa
const DESTINATION = "group"; // group , private, both
const APIKEY = "Seita_pikey"; // apikey dari autoresbot.com (paket apikey)
...
const EMAIL = "axiakrone6450@gmail.com";
const REGION = "Yokohama, Japan";
const WEBSITE = "";
const DATA_OWNER = ["625189028801", "6288242324474", "6283879363917", "6288294646434"];
